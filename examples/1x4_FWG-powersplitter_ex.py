...
if __name__ == "__main__":
    ...
    # + n * 11
    number = 18
    fwg1 = FWG(outer_radius=187 + (number - 14) * 11, zlength=1, x=90, y=150, z=0, width=6, refractive_index=n_Si, name="fwg1",
               background_index=background_index, angle_psi=28, angle_phi=-28, gap=5, number=number)
    fwg2 = FWG(outer_radius=187 + (number - 14) * 11, zlength=1, x=90, y=150, z=0, width=6, refractive_index=n_Si, name="fwg2",
               background_index=background_index, angle_psi=28, angle_phi=0, gap=5, number=number)
    ...
    waveguide1._rotate_Z(angle=25, center=[-100, 12, 0])
    waveguide2._rotate_Z(angle=-25, center=[-100, 12, 0])
    # x=0 在x=104
    taper = Taper(xlength=91, ylength=25, zlength=1, x=149, y=150, z=0, direction=-1, width=5, name="taper",
                  refractive_index=n_Si, background_index=background_index)
    ...
    taper3 = Taper(xlength=100, ylength=25, zlength=1, x=260, y=150, z=0, direction=1,
                   ...
                   name="taper3",
                   refractive_index=n_Si, background_index=background_index)
    taper1._rotate_Z(angle=25, center=[0, 12, 0])
    taper2._rotate_Z(angle=-25, center=[0, 12, 0])
    # 新建一个 grid 对象
    grid = Grid(grid_xlength=400, grid_ylength=300, grid_zlength=1, grid_spacing=20e-9, total_time=3000,
    ...
    grid.set_source(source_type="linesource",wavelength=359e-9, x=40, y=150, z=0,
                    xlength=1, ylength=20, zlength=1, polarization="y")
