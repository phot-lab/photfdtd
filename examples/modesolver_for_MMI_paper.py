...
if __name__ == "__main__":
    ...
    # 设置器件参数
    waveguide = Waveguide(
        xlength=50, ylength=36, zlength=1, x=100, y=100, z=0, refractive_index=1.4555, name="Waveguide",
        background_index=background_index
    )

    # 新建一个 grid 对象
    grid = Grid(grid_xlength=200, grid_ylength=200, grid_zlength=1, grid_spacing=60e-9,
                permittivity=background_index ** 2,
                foldername="mode_for_MMI_paper")
    ...
    data = solve.calculate_mode(lam=850e-9, neigs=2,
