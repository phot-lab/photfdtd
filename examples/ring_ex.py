...
if __name__ == "__main__":
    ...
    grid = Grid(grid_xlength=15e-6, grid_ylength=2500e-9, grid_zlength=15e-6, grid_spacing=50e-9,
                permittivity=index_Re_SiO2 ** 2, foldername="test_0109")
    ...
    # grid.set_PML(pml_width=1.0e-6, pml_width_y=0, pml_width_z=1.0e-6)
    ...
    grid.save_fig(axis="y", axis_index=25)
