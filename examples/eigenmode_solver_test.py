...
if __name__ == "__main__":
    background_index = 3.1

    # 设置器件参数
    waveguide = Waveguide(
        xlength=1, ylength=40, zlength=30, x=0, y=50, z=40, refractive_index=3.47638, name="Waveguide",
        background_index=background_index
    )

    # 新建一个 grid 对象
    grid = Grid(grid_xlength=1, grid_ylength=100, grid_zlength=80, grid_spacing=20e-9,
                permittivity=background_index ** 2,
                foldername="test_eigenmode")
