...
if __name__ == "__main__":
    ...
    fiber = Fiber(length=1 * 200e-9, radius=[20 * 200e-9], refractive_index=[1.4504],
    ...
    # 绘制折射率分布
    solve.plot()
    # We can plot the geometry now 绘制z=0截面结构图
    grid.save_fig(axis="z", axis_number=0)

    # 计算这个截面处，波长1.55um，折射率1.4504附近的20个模式，边界条件选择在四个方向上都是pml
