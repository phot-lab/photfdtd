...
if __name__ == "__main__":
    ...
    waveguide = Waveguide(
        xlength=400e-9, ylength=200e-9, zlength=4e-6, refractive_index=index_Re_Si, name="waveguide", grid=grid
    )
    ...
    grid.set_source(source_type="linesource",
                    wavelength=1550e-9, name="source", x=2000e-9, y=None, z=1200e-9, pulse_length=30e-15,
    ...
    grid.run(animate=False, save=True, interval=20, time=100)
