    ...
    def _set_objects(self):
        ...
        for i in range(self.outer_radius):
            ...
            if border_t != -1:
                # print(border_d)
                # print(border_t)
                waveguide = Waveguide(xlength=1, ylength=border_d - border_t + 1, zlength=self.zlength,
                                                        x=self.x + i, y=self.y + border_t, z=self.z,
                                                        name=self.name+ " " + str(i), refractive_index=self.refractive_index)
